...
class ProjectPlayer extends ClientPlayer {
    ...
    /**
      * 事件：监听道具数目改变
      */
    static CHANGE_ITEM_NUMBER = "ProjectPlayerCHANGE_ITEM_NUMBER";
    /**
     * 事件：监听金币改变
     */
    static CHANGE_GOLD_NUMBER = "ProjectPlayerCHANGE_GOLD_NUMBER";
    //------------------------------------------------------------------------------------------------------
    // 实例
    //------------------------------------------------------------------------------------------------------
    /**
     ...
     * @return [Module_道具] 
     */
    static getItem(itemID: number): Module_道具 {
